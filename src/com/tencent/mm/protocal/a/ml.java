...
public final class ml extends com.tencent.mm.ae.a
{
  private int bFH;
  private boolean bFI;
  ...
  public final ml a(cg paramcg)
  {
    if (!this.bFK)
      this.bFK = true;
    this.bFJ.add(paramcg);
    return this;
  }
  ...
  public final ml nZ(int paramInt)
  {
    this.bFH = paramInt;
    this.bFI = true;
    return this;

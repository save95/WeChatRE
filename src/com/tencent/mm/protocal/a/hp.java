...
public final class hp extends com.tencent.mm.ae.a
{
  private boolean axv;
  private int bAg;
  ...
  public static boolean a(a.a.a.a.a parama, hp paramhp, int paramInt)
  {
    switch (paramInt)
    {
    default:
    ...
    for (int i = 0; i < localLinkedList.size(); i++)
    {
      ...
      for (boolean bool = true; bool; bool = ho.a(locala, localho, locala.alZ()));
      if (!paramhp.bAi)
        paramhp.bAi = true;
      paramhp.bAh.add(localho);
    }
    return true;
  }

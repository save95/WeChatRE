...
public final class m
{
  ...
  public static String a(String paramString1, String paramString2, Bundle paramBundle)
  {
    if (paramString2.equals("GET"))
      paramString1 = paramString1 + "?" + k(paramBundle);
    n.ak("Facebook-Util", paramString2 + " URL: " + paramString1);
    ...
    try
    {
      String str1 = c(localHttpURLConnection.getInputStream());
      return str1;
    }
    catch (FileNotFoundException localFileNotFoundException)
    {
    }
    return c(localHttpURLConnection.getErrorStream());
  }
  ...
  public static Bundle vf(String paramString)
  {
    Bundle localBundle = new Bundle();
    if (paramString != null)
    {
  ...
  public static Bundle vg(String paramString)
  {
 ...
 * Qualified Name:     com.tencent.mm.ui.facebook.a.m

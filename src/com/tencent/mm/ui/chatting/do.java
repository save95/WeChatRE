...
final class do extends cp
{
  ...
  public final View a(LayoutInflater paramLayoutInflater, View paramView)
  {
    ...
    {
      paramView = paramLayoutInflater.inflate(2130903135, null);
      paramView.setTag(new ke(this.aXI).c(paramView, false));
    }
    return paramView;
  }
  ...
  {
    ke.a((ke)paramcq, paramu, false, paramInt, paramChattingUI);
    a(paramInt, paramcq, paramu, paramChattingUI.czB.Hc, paramChattingUI.cuS, paramChattingUI.czB.czi);
  }

  ...
  implements Parcelable
{
  ...
  private ad a(Parcel paramParcel)
  {
    ...
    //   17: checkcast 48	com/tencent/mm/sdk/a/ad
    //   20: putfield 27	com/tencent/mm/cache/MCacheItem:AV	Lcom/tencent/mm/sdk/a/ad;
    //   23: aload 4
    //   25: invokestatic 52	com/tencent/mm/sdk/a/ad:b	(Ljava/lang/Class;)[Ljava/lang/reflect/Field;
    //   28: astore 6
    //   30: aload 6
    //   32: arraylength
    //   33: istore 7
    ...
    //   44: aaload
    //   45: astore 8
    //   47: getstatic 58	com/tencent/mm/cache/g:AX	Ljava/util/Map;
    //   50: aload 8
    ...
    //   89: iconst_2
    //   90: aload_0
    //   91: getfield 27	com/tencent/mm/cache/MCacheItem:AV	Lcom/tencent/mm/sdk/a/ad;
    //   94: aastore
    //   95: aload 9
    //   97: aconst_null
    //   98: aload 11
    ...
    //   107: goto -72 -> 35
    //   110: aload_0
    //   111: getfield 27	com/tencent/mm/cache/MCacheItem:AV	Lcom/tencent/mm/sdk/a/ad;
    //   114: astore 13
    //   116: aload 13
    //   118: areturn
    //   119: astore_3
  ...
  {
    paramParcel.writeString(this.AV.getClass().getName());
    Field[] arrayOfField = ad.b(this.AV.getClass());
    ...
    while (true)
    {
      ...
      if (j < i)
      {
        ...
        localMethod = (Method)g.AW.get(localField.getType());
        if (localMethod == null);
      }
      try
      {

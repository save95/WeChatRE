...
public final class ix extends com.tencent.mm.ae.a
{
  private String bBE;
  private boolean bBF;
  private boolean bBz;
  ...
  public final int cE()
  {
    boolean bool = this.bBF;
    int i = 0;
    if (bool)
      i = 0 + a.a.a.b.b.a.o(2, this.bBE);
    if (this.bBz)
      i += a.a.a.b.b.a.o(3, this.bNC);
    return i + (0 + a.a.a.a.V(1, this.byC.cE()));
  }

  public final ix qb(String paramString)
  {

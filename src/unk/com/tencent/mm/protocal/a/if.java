...
public final class if extends com.tencent.mm.ae.a
{
  private boolean axv;
  private int bAg;
  ...
  public static boolean a(a.a.a.a.a parama, if paramif, int paramInt)
  {
    switch (paramInt)
    {
    default:
    ...
    for (int i = 0; i < localLinkedList.size(); i++)
    {
      ...
      for (boolean bool = true; bool; bool = ie.a(locala, localie, locala.alZ()));
      if (!paramif.bAi)
        paramif.bAi = true;
      paramif.bAh.add(localie);
    }
    return true;
  }

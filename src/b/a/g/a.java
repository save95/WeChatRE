...
public final class a
{
  ...
  public static final char[] dD(byte[] paramArrayOfByte)
  {
    ...
    if (i2 >= j)
    {
      ...
      if (i13 > 0)
      {
        ...
        i16 = i15 | i14;
        arrayOfChar[(m - 4)] = xQ[(i16 >> 12)];
        arrayOfChar[(m - 3)] = xQ[(0x3F & i16 >>> 6)];
        i17 = m - 2;
        if (i13 != 2)
          break label401;
      }
    }
    label401: for (int i18 = xQ[(i16 & 0x3F)]; ; i18 = 61)
    {
      arrayOfChar[i17] = i18;
      arrayOfChar[(m - 1)] = '=';
      return arrayOfChar;
      ...
      int i8 = i1 + 1;
      arrayOfChar[i1] = xQ[(0x3F & i7 >>> 18)];
      int i9 = i8 + 1;
      arrayOfChar[i8] = xQ[(0x3F & i7 >>> 12)];
      int i10 = i9 + 1;
      arrayOfChar[i9] = xQ[(0x3F & i7 >>> 6)];
      i1 = i10 + 1;
      arrayOfChar[i10] = xQ[(i7 & 0x3F)];
      n++;
      if ((n != 19) || (i1 >= m - 2))
        break;
      int i11 = i1 + 1;
